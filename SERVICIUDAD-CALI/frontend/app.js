...
function mostrarResultado(data) {
    ...
    document.getElementById('totalAPagar').textContent = formatearMoneda(data.totalGeneral || 0);
...
function renderEstadisticas(stats) {
    ...
    const estadisticas = [
        ...
        { 
            ...
            value: `${stats.promedioConsumoAcueducto || 0} m³` 
        },
        { 
            icon: '⚡', 
            label: 'Deuda Energía', 
        ...
        { 
            ...
            value: `${stats.promedioConsumoEnergia || 0} kWh` 
        },
        { 
            icon: '📈', 
            label: 'Promedio Acueducto', 
            value: `${(stats.promedioConsumoAcueducto || 0).toFixed(1)} m³` 
        }
    ];
